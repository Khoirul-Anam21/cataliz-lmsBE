...
export const authorizeFacil = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    if (user.role !== 'facilitator') throw new ApiError(401, {msg: "must login as facilitator"});
