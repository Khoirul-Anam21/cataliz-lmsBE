...
import { ReadParticipantCourseReportService } from "../services/read-participant-course.service copy";
...
export const readParticipantCourseReport = async (req: Request, res: Response, next: NextFunction) => {
  try {
    ...
    const result = await readParticipantCourseReportService.handle(req.params.id, req.body.user_id);
